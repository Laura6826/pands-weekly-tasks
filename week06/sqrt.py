...
# Newtons method for square roots, is a technique for finding the square root of a number by
# iteratively improving an initial guess.
...
def newtons_method_sqrt(num, estimate):
    ...
    new_estimate= int(((num / estimate)+ estimate)/ 2)
...
# Check point values 
# print (newtons_method_sqrt(20,4))

original_num= int(input(
   'Step 1: Please enter the number you wish to retrieve the square root of: '))

# how to check if input is an integer was researched.
# Reference: https://www.pythonpool.com/python-check-if-string-is-integer/
